...
class Row(Problem):
    ...
    def successor(self, state):
        ...
        # print(str(initial_row))
        # print(str(goal_row) + '\n')

        for i in range(0, len(goal_row)):
            # print(f'i = {i}')
            # print(f'element = {initial_row[i]}')
            if initial_row[i] == 0:
                continue
